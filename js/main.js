(function () {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (!NAV.contains(e.target) && !NAV_TOGGLE.contains(e.target)) {
      NAV.classList.remove("is-open");
      NAV_TOGGLE.classList.remove("is-open");
      document.body.style.overflow = "";
    }
  ...
  const revealEls = document.querySelectorAll(
    ".section-head, .about-grid, .about-content, .about-visual, .value-card, .product-card, .contact-grid, .contact-info, .contact-form-wrap",
  );
  ...
  if (CONTACT_FORM) {
    CONTACT_FORM.addEventListener("submit", function (e) {
      ...
      var mailto =
        "mailto:Lionteamtactical@gmail.com?subject=" +
